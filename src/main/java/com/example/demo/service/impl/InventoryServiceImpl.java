...
import com.example.demo.dto.request.StockAdjustmentRequest;
import com.example.demo.dto.response.InventoryReportResponse;
import com.example.demo.dto.response.InventoryTransactionResponse;
import com.example.demo.entity.InventoryTransaction;
import com.example.demo.entity.Product;
import com.example.demo.entity.StockAdjustment;
import com.example.demo.entity.User;
import com.example.demo.enums.InventoryTransactionType;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    // ========== ✅ CORE TRANSACTION METHOD - UPDATES PRODUCT STOCK ==========
    ...
    public void createInventoryTransaction(
        ...
        switch (type) {
            ...
            case ADJUSTMENT:
                ...
                stockChange = quantity;  // This is the delta (positive or negative)
                break;
        }
    ...
    public InventoryTransactionResponse adjustStock(StockAdjustmentRequest request, Long adjustedByUserId) {
        ...
        // ❌ REMOVE THIS - Stock will be updated by createInventoryTransaction
        ...
        // ✅ CREATE INVENTORY TRANSACTION - This will update the stock
