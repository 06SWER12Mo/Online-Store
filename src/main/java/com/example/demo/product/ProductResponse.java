...
public class ProductResponse {
    ...
    public ProductResponse(Product product) {
        ...
        product.getImages().stream()
                ...
                .findFirst()
                .ifPresent(img -> this.primaryImageUrl = img.getImageUrl());
        
        if (this.primaryImageUrl == null && !product.getImages().isEmpty()) {
            this.primaryImageUrl = product.getImages().get(0).getImageUrl();
        }
    }
    ...
    public void setSpecifications(List<ProductSpecificationResponse> specifications) {
